...
def build_minimax_capability() -> ProviderCapability:
    settings = get_settings()
    default_model = settings.minimax_default_model
    ws_model = settings.minimax_ws_model

    models = sorted(set([default_model, ws_model, "speech-2.8-hd"]))
    ...
    return ProviderCapability(
        ...
        voice_clone=VoiceCloneCapability(
            ...
            max_file_size_mb=settings.clone_audio_max_size_mb,
        ),
        ...
        metadata={
            "base_url_configured": bool(settings.minimax_base_url),
