...
**P18-XIANGTA-VOICE-PRESETS-API-C1 ✅ → 当前阶段：P18-XIANGTA-VOICE-PRESET-RESOLUTION-C2**
...
| P18-XIANGTA-VOICE-PRESET-RESOLUTION-C2 | 强化 voicePreset → coreProfileId 解析，处理占位符/disabled/profile_not_found | Codex | Next |
...
下一步进入 `P18-XIANGTA-VOICE-PRESET-RESOLUTION-C2`。P18-C2 强化 voicePreset → coreProfileId 解析，不改 H5，不改 Core。
