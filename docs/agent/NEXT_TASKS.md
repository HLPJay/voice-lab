...
**P18-XIANGTA-MANUAL-H5-VALIDATION-C10B ✅ → 当前阶段：P18-XIANGTA-LLM-PROMPT-CONTRACT-C10C**
...
下一步进入 `P18-XIANGTA-LLM-PROMPT-CONTRACT-C10C`。C10C 只做 LLM prompt contract、离线样本和评估结构，不接真实 Provider，不读取真实 API key，不修改 H5 主流程。
