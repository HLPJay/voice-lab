...
| P14-CONTEXT-B0 | design ContextStore for recoverable creation context | P14-LONGTEXT-UX-B0 完成 |
| P14-PRODUCT-B0 | design global SampleSidebar visibility | P14-LONGTEXT-UX-B0 完成 |
| P14-PRODUCT-B1 | design preview/detail behavior for long samples | P14-LONGTEXT-UX-B0 完成 |
