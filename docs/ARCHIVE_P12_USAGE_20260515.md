...
- `dev` 指向 P12 最终归档点
- `p12-usage-archive-20260515` tag 指向同一归档点
- `p13/creation-sample-sidebar` 从同一归档点创建
- 后续 P13 开发只在 `p13/creation-sample-sidebar` 分支进行
- `dev` 暂时作为 P12 归档稳定线保留
- 本归档仅包含文档收尾，不包含业务代码变更
