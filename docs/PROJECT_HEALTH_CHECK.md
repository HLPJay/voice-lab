...
- UNSUPPORTED_PROVIDER（400）：Provider 不存在
- CAPABILITY_NOT_SUPPORTED、UNSUPPORTED_AUDIO_FORMAT、PARAM_OUT_OF_RANGE、TTS_NOT_SUPPORTED、SUBTITLE_NOT_SUPPORTED、STREAMING_NOT_SUPPORTED、EMOTION_NOT_SUPPORTED、BATCH_NOT_SUPPORTED、SCRIPT_NOT_SUPPORTED、VOICE_CLONE_NOT_SUPPORTED、VOICE_DESIGN_NOT_SUPPORTED、IMPORT_NOT_SUPPORTED 等。

**测试结果：** 568 passed, 6 skipped（+29 新增测试）。
