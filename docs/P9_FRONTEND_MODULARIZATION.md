...
**19 个 E2E**（tests/e2e/test_frontend_capabilities.py）
...
**下一步：** 补 `test_voice_design_mock_submit_success`（高优先级），再进入 `voice_clone.js` 迁移。
