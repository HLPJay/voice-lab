...
**20 个 E2E**（tests/e2e/test_frontend_capabilities.py）
...
**下一步：** P9-FE1-G1（clone 错误）+ P9-FE1-G2（design 成功）已完成，clone/design/import 三条链路的 E2E 保护均已建立。可进入 helper window 暴露前置任务或 `voice_clone.js` 抽离。
